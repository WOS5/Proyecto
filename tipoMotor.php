...
<head>
  ...
  <script src="js/funciones_tipoMotor.js"></script>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Agregar tipo_Motor</h4>
      </div>
      <div class="modal-body">
        <label>id_tipoMotor</label>
        <input type="text" name="" id="id" class="form-control input-sm">
        <label>Nombre_motor</label>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#tabla').load('componentes/consulta_tipoMotor.php');
	});
</script>
